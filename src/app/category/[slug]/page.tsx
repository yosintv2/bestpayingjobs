...
export default async function CategoryPage({ params }: Props) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: cat.name, item: `${siteUrl}/category/${slug}` },
    ],
  };
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-12">
        <div className="mx-auto max-w-4xl px-6">
          <Link href="/category" className="inline-flex items-center gap-1 text-sm text-gray-400 hover:text-emerald-600 transition-colors mb-6">
