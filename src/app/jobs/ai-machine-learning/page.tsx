...
const aiTitle = `Highest Paying AI Jobs ${CURRENT_YEAR} — AI & Machine Learning Salaries by Country`;
const aiDesc = `Discover the highest paying AI and machine learning jobs across 195 countries in ${CURRENT_YEAR}. Compare AI engineer salaries, data scientist pay, and machine learning engineer compensation worldwide.`;
const aiDescShort = `Compare AI engineer, ML engineer, and data scientist salaries across 195 countries. Find where AI skills pay the most in ${CURRENT_YEAR}.`;
...
export default function AiMachineLearningJobsPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI & Machine Learning", item: `${siteUrl}/jobs/ai-machine-learning` },
    ],
  };
